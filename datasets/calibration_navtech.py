...
if __name__ == "__main__":
    ...
    polar_dir = os.path.join(current_dir, 'HeRCULES/Mountaon/01/raw_navtech')  
    cart_dir = os.path.join(current_dir, 'HeRCULES/Mountaon/01/Navtech_before_calibration')  
    process_images(polar_dir, cart_dir, output_size=(192, 384), threshold=123)